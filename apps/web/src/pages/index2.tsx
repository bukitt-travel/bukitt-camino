            ...
            <div className="mx-auto mb-14 grid max-w-6xl grid-cols-1 gap-4 pt-8 md:grid-cols-2">
                ...
                <div className="order-1 p-5 md:order-2 md:pl-0">
                    ...
                    <div className="mb-14 text-lg ">
                        <p className="mb-4">
                            Trefoldighet Feriekoloni er Norges eldste aktive
                            feriekoloni – eller sommerleir om du vil!
                        </p>
                        <p>
                            I over 130 år har barn og unge vært på ferie hos
                            oss. Kanskje du også vil komme til sommeren?
                        </p>
                    </div>
                    <CampDates />
                    <div className="max-w-sm text-center md:text-right">
                        <p className="mr-4 mb-5 inline-block font-bold italic">
                            Vi har fulle partier, men søk gjerne og stå på
                            venteliste. Det kan bli ledige plasser.
                        </p>
