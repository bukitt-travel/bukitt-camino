...
const FAQ = ({ faq, adventures }) => {
    return (
        <Page
            metaTitle="FAQ"
            metaDescription="We answer your most important questions about Bukitt and el Cmaino de Santiago."
        >
            <div className="mx-auto max-w-3xl py-32">
                ...
                <dl className="mt-16 space-y-6 divide-y divide-dashed divide-stone-900 divide-opacity-50">
                    {faq.map((faq) => (
