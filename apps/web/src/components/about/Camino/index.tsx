...
import NavBar from '@/components/about/Camino/Navbar';
import CaminoRoutes from '@/components/about/Camino/Sections/CaminoRoutes';
import CaminoHistory from '@/components/about/Camino/Sections/CaminoHistory';
